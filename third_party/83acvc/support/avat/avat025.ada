...
PROCEDURE AVAT023 IS
     ...
     TYPE FIXED IS DELTA SYSTEM.FINE_DELTA/2 RANGE -1.0 .. 1.0;
     ...
     ACCEPT_LEN : CONSTANT TEXT_IO.FIELD := VALUE_LENGTH +
                                            RANGE_DESCR'LENGTH;
