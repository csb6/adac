...
package body Ch12 is
   ...
   --  Parsed by P_Generic_Declaration (12.1)
   ...
   --  FORMAL_TYPE_DECLARATION ::=
   --    type DEFINING_IDENTIFIER [FORMAL_DISCRIMINANT_PART]
   ...
   begin
      ...
      if P_Unknown_Discriminant_Part_Opt then
         Set_Has_Unknown_Discriminants (Decl_Node, True);
      else
   ...
   --  | FORMAL_FIXED_POINT_TYPE_DEFINITION
   --  | FORMAL_ARRAY_TYPE_DEFINITION
   --  | FORMAL_ACCESS_TYPE_DEFINITION

   --  FORMAL_REAL_TYPE_DEFINITION ::=
   --    FORMAL_FLOATING_POINT_DEFINITION | FORMAL_FIXED_POINT_DEFINITION
   ...
   begin
      ...
      case Token is
         ...
         when Tok_Private | Tok_Abstract | Tok_Limited | Tok_Tagged =>
   ...
   --  The caller has checked the initial token is NEW
   ...
   -------------------------------------------
   -- 12.5.3  Generic Array Type Definition --
   -------------------------------------------

   --  Parsed by P_Formal_Type_Definition (12.5)

   --------------------------------------------
   -- 12.5.4  Generic Access Type Definition --
   --------------------------------------------
