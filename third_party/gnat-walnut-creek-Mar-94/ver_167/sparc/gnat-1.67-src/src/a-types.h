...
/* This is the C file that corresponds to the Ada package spec Types.  It was
   created manually from the file types-.ada.
...
#define Char_Code_Bias		600000000
...
/* Value of Chars  of the parent field for record extension. */
#define Name_uParent First_Name_Id + 26
...
/* Element list Id, biased subscript value of entry in lists table.  */
typedef Int Elist_Id;

/* Bias added to subscript in list table to get Elist_Id value.  */
#define Elist_Bias (Elist_Low_Bound - List_Low_Bound)

/* Used to indicate absence of an element list.  */
#define No_Elist Elist_Low_Bound

/* Element Id, biaseed subscript value of entry in lists table.  */
typedef Int Elmt_Id;

/* Bias added to subscript in list table to get Elmt_Id value.  */
#define Elmt_Bias (Elmt_Low_Bound - List_Low_Bound)
