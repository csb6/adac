...
--  in the Sinfo spec are excluded).
...
--  argument can have side effects (e.g. be a call to a parse routine).
   ...
   function Make_Parenthesized_Expression (Sloc : Source_Ptr;
      ...
      Parens                       : Boolean := False)
      return Node_Id;
   pragma Inline (Make_Parenthesized_Expression);
   ...
   function Make_Op_And_Then (Sloc : Source_Ptr;
      ...
      Parens                       : Boolean := False)
      return Node_Id;
   pragma Inline (Make_Op_And_Then);
   ...
   function Make_Expression_Actions (Sloc : Source_Ptr;
      ...
      Parens                       : Boolean := False)
      return Node_Id;
   pragma Inline (Make_Expression_Actions);
   ...
   function Make_Implicit_Type (Sloc : Source_Ptr;
      Defining_Identifier          : Node_Id)
      return Node_Id;
   pragma Inline (Make_Implicit_Type);
