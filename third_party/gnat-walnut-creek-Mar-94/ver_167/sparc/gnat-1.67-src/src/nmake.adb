...
--                                 B o d y                                  --
--                                                                          --
--                 Generated by xnmake revision 1.11 using                   --
--                         sinfo.ads revision 1.128                          --
--                         nmake.adt revision 1.2                          --
--                                                                          --
...
package body Nmake is
   ...
   begin
      Set_Numerator (N, Numerator);
      Set_Denominator (N, Denominator);
      Set_Decimal (N, Decimal);
      Set_Parens (N, Parens);
      return N;
   ...
   is
      N : constant Node_Id :=
            Extend_Node (New_Node (N_Defining_Identifier, Sloc));
   begin
      Set_Chars (N, Chars);
      return N;
   ...
   is
      N : constant Node_Id :=
            Extend_Node (New_Node (N_Defining_Character_Literal, Sloc));
   begin
      Set_Chars (N, Chars);
      return N;
   ...
   function Make_Component_List (Sloc : Source_Ptr;
      Component_Declarations       : List_Id;
   ...
   begin
      Set_Component_Declarations (N, Component_Declarations);
   ...
   function Make_Incomplete_Type_Declaration (Sloc : Source_Ptr;
      Defining_Identifier          : Node_Id;
      Discriminant_Specifications  : List_Id := No_List;
      Has_Unknown_Discriminants    : Boolean := False)
      return Node_Id
   is
      N : constant Node_Id :=
   ...
   begin
      Set_Defining_Identifier (N, Defining_Identifier);
      Set_Discriminant_Specifications (N, Discriminant_Specifications);
      Set_Has_Unknown_Discriminants (N, Has_Unknown_Discriminants);
      return N;
   ...
   function Make_Parenthesized_Expression (Sloc : Source_Ptr;
      Expression                   : Node_Id;
      Parens                       : Boolean := False)
      return Node_Id
   is
      N : constant Node_Id :=
            New_Node (N_Parenthesized_Expression, Sloc);
   begin
      Set_Expression (N, Expression);
      Set_Parens (N, Parens);
      return N;
   ...
   function Make_Op_And_Then (Sloc : Source_Ptr;
      Left_Opnd                    : Node_Id;
      Right_Opnd                   : Node_Id;
      Parens                       : Boolean := False)
      return Node_Id
   is
      N : constant Node_Id :=
            New_Node (N_Op_And_Then, Sloc);
   begin
      Set_Left_Opnd (N, Left_Opnd);
      Set_Right_Opnd (N, Right_Opnd);
      Set_Parens (N, Parens);
      Set_Chars (N, Name_Op_And_Then);
      return N;
   end Make_Op_And_Then;
   ...
   function Make_Op_Or_Else (Sloc : Source_Ptr;
      Left_Opnd                    : Node_Id;
      Right_Opnd                   : Node_Id;
      Parens                       : Boolean := False)
      return Node_Id
   is
      N : constant Node_Id :=
            New_Node (N_Op_Or_Else, Sloc);
   begin
      Set_Left_Opnd (N, Left_Opnd);
      Set_Right_Opnd (N, Right_Opnd);
      Set_Parens (N, Parens);
      Set_Chars (N, Name_Op_Or_Else);
      return N;
   end Make_Op_Or_Else;
   ...
   function Make_Op_In (Sloc : Source_Ptr;
      Left_Opnd                    : Node_Id;
      Right_Opnd                   : Node_Id;
      Parens                       : Boolean := False)
      return Node_Id
   is
      N : constant Node_Id :=
            New_Node (N_Op_In, Sloc);
   begin
      Set_Left_Opnd (N, Left_Opnd);
      Set_Right_Opnd (N, Right_Opnd);
      Set_Parens (N, Parens);
      Set_Chars (N, Name_Op_In);
      return N;
   end Make_Op_In;

   function Make_Op_Not_In (Sloc : Source_Ptr;
      Left_Opnd                    : Node_Id;
      Right_Opnd                   : Node_Id;
      Parens                       : Boolean := False)
      return Node_Id
   is
      N : constant Node_Id :=
            New_Node (N_Op_Not_In, Sloc);
   begin
      Set_Left_Opnd (N, Left_Opnd);
      Set_Right_Opnd (N, Right_Opnd);
      Set_Parens (N, Parens);
      Set_Chars (N, Name_Op_Not_In);
      return N;
   end Make_Op_Not_In;
   ...
   is
      N : constant Node_Id :=
            Extend_Node (New_Node (N_Defining_Program_Unit_Name, Sloc));
   begin
      Set_Name (N, Name);
      Set_Defining_Identifier (N, Defining_Identifier);
      return N;
   ...
   is
      N : constant Node_Id :=
            Extend_Node (New_Node (N_Defining_Operator_Symbol, Sloc));
   begin
      Set_Chars (N, Chars);
      return N;
   ...
   function Make_Function_Call (Sloc : Source_Ptr;
      Name                         : Node_Id;
      Parameter_Associations       : List_Id := No_List;
      Do_Elaboration_Check         : Boolean := False;
      Parens                       : Boolean := False)
      return Node_Id
   is
      N : constant Node_Id :=
   ...
   begin
      Set_Name (N, Name);
      Set_Parameter_Associations (N, Parameter_Associations);
      Set_Do_Elaboration_Check (N, Do_Elaboration_Check);
      Set_Parens (N, Parens);
      return N;
   ...
   function Make_Entry_Declaration (Sloc : Source_Ptr;
      ...
      Parameter_Specifications     : List_Id)
      return Node_Id
   is
      N : constant Node_Id :=
   ...
   is
      N : constant Node_Id :=
            Extend_Node (New_Node (N_Entry_Body, Sloc));
   begin
      Set_Defining_Identifier (N, Defining_Identifier);
   ...
   is
      N : constant Node_Id :=
            Extend_Node (New_Node (N_Entry_Body_Formal_Part, Sloc));
   begin
   ...
   function Make_Selective_Accept (Sloc : Source_Ptr;
      Selective_Accept_Alternatives : List_Id;
      Else_Statements              : List_Id := No_List)
      return Node_Id
   is
      N : constant Node_Id :=
   ...
   begin
      Set_Selective_Accept_Alternatives
        (N, Selective_Accept_Alternatives);
      Set_Else_Statements (N, Else_Statements);
      return N;
   ...
   function Make_Compilation_Unit (Sloc : Source_Ptr;
      ...
      Unit                         : Node_Id;
      Following_Pragmas            : List_Id := No_List)
      return Node_Id
   is
      N : constant Node_Id :=
   ...
   begin
      ...
      Set_Unit (N, Unit);
      Set_Following_Pragmas (N, Following_Pragmas);
      return N;
   ...
   function Make_Expression_Actions (Sloc : Source_Ptr;
      Actions                      : List_Id;
      Expression                   : Node_Id;
      Parens                       : Boolean := False)
      return Node_Id
   is
      N : constant Node_Id :=
            New_Node (N_Expression_Actions, Sloc);
   begin
      Set_Actions (N, Actions);
      Set_Expression (N, Expression);
      Set_Parens (N, Parens);
      return N;
   end Make_Expression_Actions;
   ...
   function Make_Implicit_Type (Sloc : Source_Ptr;
      Defining_Identifier          : Node_Id)
      return Node_Id
   is
      N : constant Node_Id :=
            New_Node (N_Implicit_Type, Sloc);
   begin
      Set_Defining_Identifier (N, Defining_Identifier);
      return N;
   end Make_Implicit_Type;
