...
pragma Ada_9X;
function System.Img_C (V : Character; B : Address) return Natural;
pragma Inline (System.Img_C);
--  Computes Character'Image (V) and stores the resulting string into the
