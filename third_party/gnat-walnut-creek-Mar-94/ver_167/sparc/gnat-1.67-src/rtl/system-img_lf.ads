...
pragma Ada_9X;
function System.Img_LF (V : Long_Float; B : Address) return Natural;
pragma Inline (System.Img_LF);
--  Computes Long_Float'Image (V) and stores the resulting string into the
