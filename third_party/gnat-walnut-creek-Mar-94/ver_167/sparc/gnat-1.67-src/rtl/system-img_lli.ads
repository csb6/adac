...
pragma Ada_9X;
function System.Img_LLI (V : Long_Long_Integer; B : Address) return Natural;
pragma Inline (System.Img_LLI);
--  Computes Long_Long_Integer'Image (V) and stores the resulting string into
