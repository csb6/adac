...
pragma Ada_9X;
function System.Img_LLF (V : Long_Long_Float; B : Address) return Natural;
pragma Inline (System.Img_LLF);
--  Computes Long_Long_Float'Image (V) and stores the resulting string into
--  the buffer B, followed by a possible NUL character (the NUL character may
