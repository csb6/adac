...
pragma Ada_9X;
function System.Img_SF (V : Short_Float; B : Address) return Natural;
pragma Inline (System.Img_SF);
--  Computes Short_Float'Image (V) and stores the resulting string into the
